<template>
    <div class="wmcs-wjdc">
        ...
        <div class="capit-list">
            <el-table :data="wjdcList" stripe border style="width: 100%">
            ...
            <el-dialog :title="textTit" :visible.sync="newModal" :before-close="btn_cancel" >          
                <el-form :inline="true" :model="wjdcForm" ref="wjdcForms" class="demo-form-inline" label-width="120px" :rules="wjdcrules"> 
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="年度" prop="year">
                                <el-select v-model="wjdcForm.year" placeholder="请选择" style="width:100%">
                        ...
                        <el-col :span="11" :offset="1">
                            <el-form-item label="问卷调查时间" prop="sj">
                                <el-date-picker v-model="wjdcForm.sj" type="date" value-format="timestamp" placeholder="问卷调查时间"></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="11" >
                            <el-form-item label="接收行政区划" prop="jsXzqh">
                                <el-input v-model="wjdcForm.jsXzqh" placeholder="接收行政区划" @focus="modelStatus('xzqh')"></el-input>
                        </el-form-item>
                        </el-col>
                        <el-col :span="11" :offset="1">
                        <el-form-item label="问题接收部门" prop="jsBm">
                                <el-input v-model="wjdcForm.jsBm" placeholder="问题接收部门" @focus="modelStatus('bm')"></el-input>                        
                        </el-form-item>
                        </el-col>      
                    </el-row>
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="回复时间" prop="hfsj">
                                <el-date-picker v-model="wjdcForm.hfsj" type="date" value-format="timestamp" placeholder="回复时间"></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="23">
                                <el-form-item label="主题描述" prop="ztms">  
                                    <el-input type="textarea" v-model.trim="wjdcForm.ztms" :autosize="{ minRows: 5}"></el-input>
                                </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="行政区划" prop="xzqh">
                                <el-select v-model="wjdcForm.xzqh" placeholder="请选择" style="width:100%" disabled>
                        ...
                        <el-col :span="11" :offset="1">
                            <el-form-item label="部门科室" prop="bm">
                                <el-select v-model="wjdcForm.bm" placeholder="请选择" style="width:100%" disabled>
                    ...
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="录入人" prop="lrr">
                                <el-input v-model="wjdcForm.lrr" placeholder="录入人" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="11" :offset="1">
                            <el-form-item label="录入时间" prop="lrsj">
                                <el-date-picker v-model="wjdcForm.lrsj" type="datetime" value-format="timestamp" placeholder="录入时间" :disabled="true"></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
...
export default {
  ...
  methods: {
    ...
    formInit() {
      ...
      this.wjdcForm.lrsj = nowDate;
      this.wjdcForm.bm = this.$store.state.user.user.uUser.bmbm;
      this.wjdcForm.xzqh = this.$store.state.user.user.uUser.xzqh;
      this.wjdcForm.lrr = this.$store.state.user.user.uUser.nickname;
    },
    CurrentChange(val) {
      this.pageNo = val;
      this.search_query();
    ...
    bmnodeClick(data) {
        this.bmbm = data.bm;
        this.wjdcForm.jsBm = data.name;
        this.xzqh_model = false;
        this.bm_model = false;
    },
    nodeClick(data) {
        this.xzqh = data.bm;
        this.wjdcForm.jsXzqh = data.name;
        this.wjdcForm.jsBm = "";
        this.xzqh_model = false;
        this.bm_model = false;
    },
    ...
    newAdd() {
      ...
      this.textTit = "添加记录";
      this.wjdcForm = {};
      if (this.$refs.wjdcForms) {
        this.$refs.wjdcForms.resetFields();
      }
      this.formInit();
    },
    search_query() {
    ...
    Edit(row) {
      ...
      this.wjdcForm = Object.assign({}, row);
    },
    btn_save() {
      let _this = this;
      this.$refs.wjdcForms.validate(valid => {
        if (valid) {
          let obj = Object.assign({}, _this.wjdcForm);
    ...
    chileFile(val) {
      let zd = val.zdName;
      this.wjdcForm[zd] = val.newSrcstr;
    },
    fileClick(val) {
