        ...
        <div v-show="applyXg">
            ...
            <div class="capit-tit">
                <el-row>
                    <el-col :span="12">
                        <div class="user-left">
                            <span class="capit-content">党员发展</span>
                        </div>
                    </el-col>
                </el-row>
            </div>
                        ...
                        <el-form :inline="true" :model="editObj" ref="editObj" class="demo-form-inline" label-width="120px" :rules="rulesFile">
                            ...
                            <el-row>
                                <el-col :span="11">
                                    <el-form-item label="录入人" prop="lrr">
                                        <el-input v-model.trim="editObj.lrr" placeholder="录入人" :disabled="true"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="11" :offset="1">
                            ...
                            <el-row>
                                <el-col :span="20" :offset="3">
                                    <el-button type="success" size="small" @click="fileClick('rymd')">人员名单</el-button>
                                    <el-button type="success" size="small" @click="fileClick('fzjh')">发展计划</el-button>
                                </el-col>
                            </el-row>
                        </el-form>
                    </div>
...
import { dateQuery, dateAdd, dateUpdate, dateDel } from "@/api/zzjs/dygl/dyfz";
export default {
    components: {
        accessoryModel,
        applyrModifying
