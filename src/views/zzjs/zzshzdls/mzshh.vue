    ...
    <div v-show="applyXg">
      ...
      <div class="capit-tit">
        <el-row>
          <el-col :span="12">
            <div class="user-left">
              <span class="capit-content">民主生活会</span>
            </div>
          </el-col>
        </el-row>
      </div>
                ...
                <el-row>
                  <el-col :span="23">
                    <el-form-item label="问题清单" prop="wtqd">
                      <el-input type="textarea" v-model="shykForm.wtqd" :autosize="{ minRows: 3}"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="23">
                    <el-form-item label="受处分党员会上说明" prop="cfdysm">
                      <el-input type="textarea" v-model.trim="shykForm.cfdysm" :autosize="{ minRows: 3}"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
