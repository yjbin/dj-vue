        ...
        <div v-show="applyXg">
            ...
            <div class="capit-tit">
                <el-row>
                    <el-col :span="12">
                        <div class="user-left">
                            <span class="capit-content">志愿服务</span>
                        </div>
                    </el-col>
                </el-row>
            </div>
                ...
                <el-dialog :title="textTit" :visible.sync="newModal" :before-close="btn_cancel">
                    <div class="dict-content">
                        <el-form :inline="true" :model="editObj" ref="editObj" class="demo-form-inline" label-width="120px" :rules="rulesFile">
                            ...
                            <el-row>
                                <el-col :span="11">
                                    <el-form-item label="用时(小时)" prop="by1">
                                        <el-input v-model.trim="editObj.by1" placeholder="用时(小时)"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
...
import { validMoney, validName } from "@/utils/validate";
export default {
    components: {
        accessoryModel,
        applyrModifying
    ...
    data() {
        ...
        const validOfyongs = (rule, value, callback) => {
            if (!validMoney(value)) {
        ...
        return {
            ...
            rulesFile: {
                ...
                by1: [{ required: true, validator: validOfyongs }]
            },
