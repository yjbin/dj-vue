            ...
            <el-row>
              ...
              <el-col :span="11" :offset="1">
                <el-form-item label="报备时间" prop="bbsj">
                  <el-date-picker v-model="editObj.bbsj" type="date" value-format="timestamp" placeholder="报备时间"></el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              ...
              <el-row>
                ...
                <el-col :span="11" :offset="1">
                  <el-form-item label="检查时间" prop="jcsj">
                    <el-date-picker v-model="editObj.jcsj" type="date" value-format="timestamp" placeholder="检查时间"></el-date-picker>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
