        ...
        <div v-show="applyXg">
            <el-form :inline="true" class="demo-form-inline">
                <el-form-item label="机构名称">
                    <el-input placeholder="机构名称" prefix-icon="el-icon-search" v-model.trim="seatch_jgmc"></el-input>
                </el-form-item>
                <!-- <el-form-item label="组长">
                    <el-input placeholder="组长" prefix-icon="el-icon-search" v-model.trim="seatch_zz"></el-input>
                </el-form-item> -->
                <el-form-item>
            ...
            <div class="capit-tit">
                <el-row>
                    <el-col :span="12">
                        <div class="user-left">
                            <span class="capit-content">意识形态领导组组织机构</span>
                        </div>
                    </el-col>
                </el-row>
            </div>
            <div class="capit-list">
                <el-table :data="dateList" stripe border style="width: 100%" @selection-change="checkboxChange">
                    ...
                    <el-table-column prop="jgmc" label="机构名称" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="zz" label="组长" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="fzz" label="副组长" show-overflow-tooltip></el-table-column>
                            ...
                            <el-row>
                                <el-col :span="11">
                                    <el-form-item label="机构名称" prop="jgmc">
                                        <el-input v-model.trim="editObj.jgmc" placeholder="机构名称"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="11" :offset="1">
                                    <el-form-item label="组长" prop="zz">
                                        <el-input v-model.trim="editObj.zz" placeholder="组长"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row>
                                <el-col :span="23">
                                    <el-form-item label="副组长" prop="fzz">
                                        <el-input type="textarea" v-model.trim="editObj.fzz" placeholder="副组长"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
                                <el-col :span="23">
                                    <el-form-item label="成员" prop="cy">
                                        <el-input type="textarea" v-model.trim="editObj.cy" placeholder="成员"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
...
import { dateQuery, dateAdd, dateUpdate, dateDel } from "@/api/sxjs/zzjg";
...
export default {
    ...
    data() {
        ...
        return {
            ...
            fileSrc: "",
            rulesFile: {
                jgmc: [{ required: true, message: "不能为空" }],
                zz: [{ required: true, validator: validNames }],
    ...
    methods: {
        ...
        ListQuery() {
            ...
            this.seatch_jgmc ? (obj.jgmc = this.seatch_jgmc) : "";
            this.seatch_zz ? (obj.zz = this.seatch_zz) : "";
