    ...
    <div class="jcdjsz">
        <div v-show="applyXg">
            <el-form :inline="true" class="demo-form-inline">
                ...
                <el-form-item label="述职人">
                    <el-input placeholder="请输入述职人" prefix-icon="el-icon-search" v-model.trim="seatch_szr"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <div class="capit-tit">
                <el-row>
                    <el-col :span="12">
                        <div class="user-left">
                            <span class="capit-content">基层党建述职考核评议</span>
                        </div>
                    </el-col>
                </el-row>
            </div>
            <div class="capit-list">
                <el-table :data="dateList" stripe border style="width: 100%" @selection-change="checkboxChange">
                    ...
                    <el-table-column prop="szr" label="述职人" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="year" label="年度" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="szsj" label="述职时间" :formatter="sjDic" show-overflow-tooltip></el-table-column>
                ...
                <el-dialog :title="textTit" :visible.sync="newModal" :before-close="btn_cancel">
                    <div class="dict-content">
                        <el-form :inline="true" :model="editObj" ref="editObj" class="demo-form-inline" label-width="120px" :rules="rulesFile">
                            <el-row>
                                <el-col :span="11">
                                    <el-form-item label="述职人" prop="szr">
                                        <el-input v-model.trim="editObj.szr" placeholder="述职人"></el-input>
                                    </el-form-item>
                                </el-col>
                            ...
                            <el-row>
                                <el-col :span="11">
                                    <el-form-item label="述职时间" prop="szsj">
                                        <el-date-picker v-model="editObj.szsj" type="date" value-format="timestamp" placeholder="述职时间" :editable="false"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row>
                                <el-col :span="20" :offset="3">
                                    <el-button type="success" size="small" @click="fileClick('szcl')">述职材料</el-button>
                                    <el-button type="success" size="small" @click="fileClick('szfa')">述职方案</el-button>
                                    <el-button type="success" size="small" @click="fileClick('khjg')">述职结果</el-button>
                                </el-col>
                            </el-row>
                        </el-form>
                    </div>
...
import {
    ...
    khpyUpdate,
    khpyDel
} from "@/api/zzjs/djzrzls/jcdzzszkhpy";
export default {
    components: {
        accessoryModel,
        applyrModifying
    ...
    data() {
        return {
            ...
            rulesFile: {
                ...
                szr: [{ required: true, message: "不能为空" }],
                szsj: [{ required: true, message: "不能为空" }]
            }
        };
    },
    methods: {
        sjDic(row) {
            return formatDate(row.szsj, "yyyy-MM-dd");
        },
        xzqhDic(row) {
        ...
        ListQuery() {
            ...
            this.seatch_szr ? (obj.szr = this.seatch_szr) : "";
