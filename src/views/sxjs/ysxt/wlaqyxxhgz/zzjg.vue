        ...
        <div v-show="applyXg">
            <el-form :inline="true" class="demo-form-inline">
                ...
                <el-form-item label="机构名称">
                    <el-input placeholder="机构名称" prefix-icon="el-icon-search" v-model.trim="seatch_name"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <div class="capit-tit">
                <el-row>
                    <el-col :span="12">
                        <div class="user-left">
                            <span class="capit-content">组织机构</span>
                        </div>
                    </el-col>
                </el-row>
            </div>
...
export default {
    ...
    methods: {
        ...
        ListQuery() {
            ...
            this.seatch_name ? (obj.jgmc = this.seatch_name) : "";
