        ...
        <div v-show="applyXg">
            <el-form :inline="true" class="demo-form-inline">
                ...
                <el-form-item label="责任单位">
                    <el-input placeholder="责任单位" prefix-icon="el-icon-search" v-model.trim="seatch_zrdw"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <div class="capit-tit">
                <el-row>
                    <el-col :span="12">
                        <div class="user-left">
                            <span class="capit-content">品牌打造情况</span>
                        </div>
                    </el-col>
                </el-row>
            </div>
            <div class="capit-list">
                <el-table :data="dateList" stripe border style="width: 100%" @selection-change="checkboxChange">
                    ...
                    <el-table-column prop="zrdw" label="责任单位" show-overflow-tooltip></el-table-column>
                            ...
                            <el-row>
                                <el-col :span="11">
                                    <el-form-item label="品牌主题" prop="ppzt">
                                        <el-input v-model.trim="editObj.ppzt" placeholder="品牌主题"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="11" :offset="1">
                                    <el-form-item label="责任单位" prop="zrdw">
                                        <el-input v-model.trim="editObj.zrdw" placeholder="责任单位"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
                                <el-col :span="11">
                                    <el-form-item label="品牌地点" prop="ppdd">
                                        <el-input v-model.trim="editObj.ppdd" placeholder="品牌地点"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="11" :offset="1">
                                    <el-form-item label="品牌期限" prop="ppqx">
                                        <el-input v-model.trim="editObj.ppqx" placeholder="品牌期限"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row>
                                <el-col :span="23">
                                    <el-form-item label="品牌打造" prop="ppdz">
                                        <el-input type="textarea" v-model.trim="editObj.ppdz" placeholder="品牌打造"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
...
import { dateQuery, dateAdd, dateUpdate, dateDel } from "@/api/sxjs/ppdzqk";
export default {
    components: {
        accessoryModel,
        applyrModifying
    ...
    data() {
        return {
            ...
            fileSrc: "",
            rulesFile: {
                ppzt: [{ required: true, message: "不能为空" }],
                ppdz: [{ required: true, message: "不能为空" }],
