    ...
    <div class="rrhs">
        <el-form :inline="true" class="demo-form-inline">
            <el-form-item label="年度">
                <el-select suffix-icon="el-icon-date" v-model="seatch_nd" style="width:100%" clearable>
                    <el-option v-for="(item,index) in ndoptions" :key="index" :label="item.label" :value="item.value"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="月份">
                <el-select suffix-icon="el-icon-date" v-model="seatch_month" style="width:100%" clearable>
                    <el-option v-for="(item,index) in month" :key="index" :label="item.label" :value="item.value"></el-option>
                </el-select>
            </el-form-item>
            <!-- <el-form-item label="参加人员">
                <el-input placeholder="参加人员" prefix-icon="el-icon-search" v-model.trim="seatch_cjry"></el-input>
            </el-form-item> -->
            <el-form-item>
        ...
        <div class="capit-tit">
            <el-row>
                <el-col :span="12">
                    <div class="user-left">
                        <span class="capit-content">党组织会议工作情况，重点是“三重一大”事项</span>
                    </div>
                </el-col>
            </el-row>
        </div>
                        ...
                        <el-row>
                            <el-col :span="11">
                                <el-form-item label="会议时间" prop="hysj">
                                    <el-date-picker v-model="editObj.hysj" type="date" value-format="timestamp" placeholder="会议时间"></el-date-picker>
                                </el-form-item>
                            </el-col>
                            <el-col :span="11" :offset="1">
                        ...
                        <el-row>
                            <el-col :span="23">
                                <el-form-item label="会议内容" prop="hynr">
                                    <el-input type="textarea" v-model.trim="editObj.hynr" :autosize="{ minRows: 5}"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
...
export default {
    ...
    methods: {
        ...
        ListQuery() {
            ...
            this.seatch_cjry ? (obj.cjry = this.seatch_cjry) : "";
