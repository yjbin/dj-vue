    ...
    <div class="rrhs">
        <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item label="年度">
                <el-select v-model="seatch_nd" placeholder="请选择" clearable>
                    <el-option v-for="(item,index) in ndoptions" :key="index" :label="item.label" :value="item.value">
                    </el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="信息主题">
                <el-input placeholder="信息主题" prefix-icon="el-icon-search" v-model.trim="seatch_xxzt"></el-input>
            </el-form-item>
            <el-form-item label="报送人">
                <el-input placeholder="报送人" prefix-icon="el-icon-search" v-model.trim="seatch_bsr"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <div class="capit-tit">
            <el-row>
                <el-col :span="12">
                    <div class="user-left">
                        <span class="capit-content">信息工作</span>
                    </div>
                </el-col>
            </el-row>
        </div>
            ...
            <el-dialog :title="textTit" :visible.sync="newModal" :before-close="btn_cancel">
                <div class="dict-content">
                    <el-form :inline="true" :model="editObj" ref="editObj" class="demo-form-inline" label-width="120px" :rules="rulesFile">
                        ...
                        <el-row>
                            <el-col :span="11">
                                <el-form-item label="报送人" prop="bsr">
                                    <el-input v-model.trim="editObj.bsr" placeholder="报送人"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="11" :offset="1">
                                <el-form-item label="报送时间" prop="bssj">
                                    <el-date-picker v-model.trim="editObj.bssj" type="date" value-format="timestamp" placeholder="报送时间"></el-date-picker>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="23">
                                <el-form-item label="报送情况" prop="bsqk">
                                    <el-input type="textarea" v-model.trim="editObj.bsqk" placeholder="报送情况"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
...
import { dateQuery, dateAdd, dateUpdate, dateDel } from "@/api/sxjs/xxgz";
export default {
    components: {
        accessoryModel
    },
    data() {
        return {
            ...
            rulesFile: {
                ...
                bsr: [{ required: true, message: "不能为空" }],
