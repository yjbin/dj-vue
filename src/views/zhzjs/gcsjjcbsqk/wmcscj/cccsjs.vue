    ...
    <div class="wmcs—csjs">
        <el-form :inline="true" class="demo-form-inline">
            ...
            <!-- <el-form-item label="接收部门">
                <el-input placeholder="接收部门" prefix-icon="el-icon-search" v-model.trim="seatch_js_bm"></el-input> 
            </el-form-item> -->
            <el-form-item>
        ...
        <div class="capit-list">
            <el-table :data="csjsList" stripe border style="width: 100%">
            ...
            <el-dialog :title="textTit" :visible.sync="newModal" :before-close="btn_cancel" >          
                <el-form :inline="true" :model="csjsForm" ref="csjsForms" class="demo-form-inline" label-width="120px" :rules="csjsrules"> 
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="年度" prop="year">
                                <el-select v-model="csjsForm.year" placeholder="请选择" style="width:100%">
                        ...
                        <el-col :span="11" :offset="1">
                            <el-form-item label="问卷调查时间" prop="sj">
                                <el-date-picker v-model="csjsForm.sj" type="date" value-format="timestamp" placeholder="问卷调查时间"></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="11" >
                            <el-form-item label="接收行政区划" prop="jsXzqh">
                                <el-input v-model="csjsForm.jsXzqh" placeholder="接收行政区划" @focus="modelStatus('xzqh')"></el-input>
                        </el-form-item>
                        </el-col>
                        <el-col :span="11" :offset="1">
                        <el-form-item label="问题接收部门" prop="jsBm">
                                <el-input v-model="csjsForm.jsBm" placeholder="问题接收部门" @focus="modelStatus('bm')"></el-input>                        
                        </el-form-item>
                        </el-col>                      
                    </el-row>
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="回复时间" prop="hfsj">
                                <el-date-picker v-model="csjsForm.hfsj" type="date" value-format="timestamp" placeholder="回复时间"></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="23">
                                <el-form-item label="主题描述" prop="ztms">  
                                    <el-input type="textarea" v-model.trim="csjsForm.ztms" :autosize="{ minRows: 5}"></el-input>
                                </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="行政区划" prop="xzqh">
                                <el-select v-model="csjsForm.xzqh" placeholder="请选择" style="width:100%" disabled>
                        ...
                        <el-col :span="11" :offset="1">
                            <el-form-item label="部门科室" prop="bm">
                                <el-select v-model="csjsForm.bm" placeholder="请选择" style="width:100%" disabled>
                    ...
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="录入人" prop="lrr">
                                <el-input v-model="csjsForm.lrr" placeholder="录入人" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="11" :offset="1">
                            <el-form-item label="录入时间" prop="lrsj">
                                <el-date-picker v-model="csjsForm.lrsj" type="datetime" value-format="timestamp" placeholder="录入时间" :disabled="true"></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
...
export default {
  ...
  methods: {
    ...
    formInit() {
      ...
      this.csjsForm.lrsj = nowDate;
      this.csjsForm.bm = this.$store.state.user.user.uUser.bmbm;
      this.csjsForm.xzqh = this.$store.state.user.user.uUser.xzqh;
      this.csjsForm.lrr = this.$store.state.user.user.uUser.nickname;
    },
    CurrentChange(val) {
      this.pageNo = val;
      this.search_query();
    ...
    bmnodeClick(data) {
        this.bmbm = data.bm;
        this.csjsForm.jsBm = data.name;
        this.xzqh_model = false;
        this.bm_model = false;
    },
    nodeClick(data) {
        this.xzqh = data.bm;
        this.csjsForm.jsXzqh = data.name;
        this.csjsForm.jsBm = "";
        this.xzqh_model = false;
        this.bm_model = false;
    },
    ...
    newAdd() {
      ...
      this.textTit = "添加记录";
      this.csjsForm = {};
      if (this.$refs.csjsForms) {
        this.$refs.csjsForms.resetFields();
      }
      this.formInit();
    },
    search_query() {
    ...
    Edit(row) {
      ...
      this.csjsForm = Object.assign({}, row);
    },
    btn_save() {
      let _this = this;
      this.$refs.csjsForms.validate(valid => {
        if (valid) {
          let obj = Object.assign({}, _this.csjsForm);
    ...
    chileFile(val) {
      let zd = val.zdName;
      this.csjsForm[zd] = val.newSrcstr;
    },
    fileClick(val) {
