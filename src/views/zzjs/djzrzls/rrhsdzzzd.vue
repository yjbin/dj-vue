        ...
        <div v-show="applyXg">
            ...
            <div class="capit-tit">
                <el-row>
                    <el-col :span="12">
                        <div class="user-left">
                            <span class="capit-content">软弱涣散党组织整顿</span>
                        </div>
                    </el-col>
                </el-row>
            </div>
                            ...
                            <el-row>
                                <el-col :span="11">
                                    <el-form-item label="党组织负责人" prop="fzr">
                                        <el-input v-model.trim="editObj.fzr" placeholder="党组织负责人"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="11" :offset="1">
                                    <el-form-item label="问题类型" prop="wtlx">
                                        <el-select v-model="editObj.wtlx" placeholder="请选择" style="width:100%">
                                            <el-option v-for="(item,index) in wtlxoptions" :key="index" :label="item.label" :value="item.value">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                                </el-col>
...
import {
    ...
    dateUpdate,
    dateDel
} from "@/api/zzjs/djzrzls/rrhsdzzzd";
export default {
    components: {
        accessoryModel,
        applyrModifying
    ...
    methods: {
        ...
        ListQuery() {
            ...
            this.seatch_blld ? (obj.blld = this.seatch_blld) : "";
