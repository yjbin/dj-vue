    ...
    <div class="rrhs">
        <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item label="党员姓名">
                <el-input placeholder="党员姓名" prefix-icon="el-icon-search" v-model.trim="seatch_name"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <div class="capit-tit">
            <el-row>
                <el-col :span="12">
                    <div class="user-left">
                        <span class="capit-content">不合格党员组织处置</span>
                    </div>
                </el-col>
            </el-row>
        </div>
        <div class="capit-list">
            <el-table :data="dateList" stripe border style="width: 100%" @selection-change="checkboxChange">
                ...
                <el-table-column prop="name" label="党员姓名" show-overflow-tooltip></el-table-column>
                    ...
                    <el-form :inline="true" :model="editObj" ref="editObj" class="demo-form-inline" label-width="120px" :rules="rulesFile">
                        ...
                        <el-row>
                            <el-col :span="11">
                                <el-form-item label="党员姓名" prop="name">
                                    <el-input v-model.trim="editObj.name" placeholder="党员姓名" ></el-input>
                                </el-form-item>
                            </el-col>
                        ...
                        <el-row>
                            <el-col :span="20" :offset="3" >
                              <el-form-item>
                                <el-button type="success" size="small" @click="fileClick('zbcbrd')">支部初步认定</el-button>
                                <el-button type="success" size="small" @click="fileClick('zbdchs')">支部调查核实</el-button>
                                <el-button type="success" size="small" @click="fileClick('sjdwys')">上级党(工)委预审</el-button>
                                <el-button type="success" size="small" @click="fileClick('zbtlbj')">支部讨论表决</el-button>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="20" :offset="3" >
                                <el-button type="success" size="small" @click="fileClick('sjdwsp')">上级党(工)委审批</el-button>
                                <el-button type="success" size="small" @click="fileClick('zzbmsp')">组织部门审</el-button>
                                <el-button type="success" size="small" @click="fileClick('gbczjg')">公布处置结果</el-button>
                            </el-col>
                        </el-row>
                    </el-form>
                </div>
