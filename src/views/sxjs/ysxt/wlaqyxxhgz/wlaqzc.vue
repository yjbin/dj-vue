        ...
        <div v-show="applyXg">
            <el-form :inline="true" class="demo-form-inline">
                <el-form-item label="年度">
                    <el-select suffix-icon="el-icon-date" clearable v-model="seatch_nd">
                        <el-option v-for="(item,index) in ndoptions" :key="index" :label="item.label" :value="item.value">
                        </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="自查人">
                    <el-input placeholder="自查人" prefix-icon="el-icon-search" v-model.trim="seatch_name"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <div class="capit-tit">
                <el-row>
                    <el-col :span="12">
                        <div class="user-left">
                            <span class="capit-content">网络安全自查</span>
                        </div>
                    </el-col>
                </el-row>
            </div>
            <div class="capit-list">
                <el-table :data="dateList" stripe border style="width: 100%" @selection-change="checkboxChange">
                    ...
                    <el-table-column prop="zcsj" label="自查时间" :formatter="sjDic" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="zcr" label="自查人" show-overflow-tooltip></el-table-column>
                        ...
                        <el-form :inline="true" :model="editObj" ref="editObj" class="demo-form-inline" label-width="120px" :rules="rulesFile">
                            <el-row>
                                ...
                                <el-col :span="11" :offset="1">
                                    <el-form-item label="自查时间" prop="zcsj">
                                        <el-date-picker v-model="editObj.zcsj" type="date" value-format="timestamp" placeholder="宣传时间"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row>
                                <el-col :span="11">
                                    <el-form-item label="自查人" prop="zcr">
                                        <el-input v-model.trim="editObj.zcr" placeholder="自查人"></el-input>
                                    </el-form-item>
                                </el-col>
                            ...
                            <el-row>
                                <el-col :span="23">
                                    <el-form-item label="自查内容" prop="zcnr">
                                        <el-input type="textarea" v-model.trim="editObj.zcnr" placeholder="自查内容"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
                            ...
                            <el-row>
                                <el-col :span="20" :offset="3">
                                    <el-button type="success" size="small" @click="fileClick('zcbg')">上传自查报告</el-button>
                                </el-col>
                            </el-row>
                        </el-form>
                    </div>
...
import { dateQuery, dateAdd, dateUpdate, dateDel } from "@/api/sxjs/wlaqzc";
...
export default {
    ...
    data() {
        ...
        return {
            ...
            rulesFile: {
                ...
                zcr: [{ required: true, validator: validNames }],
                year: [{ required: true, message: "不能为空" }],
                zcnr: [{ required: true, message: "不能为空" }]
            },
    ...
    methods: {
        ...
        ListQuery() {
            ...
            this.seatch_name ? (obj.zcr = this.seatch_name) : "";
